...
void keplerSgemm(const global float* restrict v__67, const global float* restrict v__68, const global float* restrict v__69, float v__70, float v__71, global float* v__106, int v_K_4, int v_M_3, int v_N_5){
	// Static local memory
